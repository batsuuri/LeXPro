...
{  
    ...
    public class SmsService : IIdentityMessageService
    {
        public  Task SendAsync(IdentityMessage message)
        {
            ...
            var accountSid = ConfigurationManager.AppSettings["SMSSid"];
            // Your Auth Token from twilio.com/console
            var authToken = ConfigurationManager.AppSettings["SMSToken"];

            TwilioClient.Init(accountSid, authToken);
            var twilio_message =  MessageResource.CreateAsync(
                to: message.Destination,
                from: ConfigurationManager.AppSettings["SMSFromPhone"],
                body: message.Body);
    ...
    public class ApplicationRoleManager : RoleManager<ApplicationRole, int>
    {
        ...
        public static bool UpdateRole(ApplicationRole _modifiedRole)
        {
            bool _retVal = false;
            try
            {
